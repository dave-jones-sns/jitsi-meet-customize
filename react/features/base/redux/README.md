Meet.NUG - redux state persistence
====================================
Meet.NUG has a persistence layer that persists specific subtrees of the redux
...
When it's done, Meet.NUG will automatically persist these subtrees and
