...
/**
 * Signals that the configuration (commonly known in Meet.NUG as config.js)
...
/**
 * Signals that a configuration (commonly known in Meet.NUG as config.js)
...
/**
 * Stores a specific Meet.NUG config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Meet.NUG config.js to store.
 * @returns {Function}
 */
