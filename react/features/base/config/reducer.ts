 ...
 * JitsiMeetJS#init(). The app will download config.js from the Meet.NUG
 ...
 * The app will download config.js from the Meet.NUG deployment and take its
 ...
 * config.js from the Meet.NUG deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = merge(
        ...
        // downloaded from the Meet.NUG deployment because the former contains
