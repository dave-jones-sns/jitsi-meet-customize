...
/**
 * Restores a Meet.NUG config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Meet.NUG config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Meet.NUG"
    // }
    // We want to have:
    // json = {
    //     config: {
