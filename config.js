...
var config = {
    ...
    // Moves all Meet.NUG 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Meet.NUG) (e.g. https://meet.jit.si/someMeeting
