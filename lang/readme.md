# Meet.NUG Translation

Meet.NUG uses [i18next](http://i18next.com) library for translation.
i18next uses separate json files for each language.


## Translating Meet.NUG

The translation of Meet.NUG is handled editing manually the language files.
...
If you want to add new functionality for Meet.NUG and you have texts that need to be translated you must add key and value in main.json file in English for each translatable text.
