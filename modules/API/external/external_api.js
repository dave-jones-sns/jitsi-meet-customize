...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Meet.NUG in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Meet.NUG.
     *
    ...
    /**
     * Getter for the prejoin video element in Meet.NUG.
     *
    ...
    /**
     * Getter for participant specific video element in Meet.NUG.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Meet.NUG
    ...
    /**
     * Removes the listeners and removes the Meet.NUG frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Meet.NUG.
     *
     ...
     * Only applies to certain Meet.NUG deploys.
