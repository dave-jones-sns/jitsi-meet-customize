...
/**
 * The react-native side of Meet.NUG's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Meet.NUG to
     *        a conference call.
     * @param handle - a call handle which by default is Meet.NUG room's URL.
